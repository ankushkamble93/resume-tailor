...
def tailor_resume_data_with_why(
    ...
    why_rules = (
        ...
        "Write 2-3 sentences in first person explaining why this specific role is "
        "interesting to this candidate. Base it on the job description below.\n"
        f"JOB DESCRIPTION EXCERPT:\n{job_description[:1500]}\n\n"
        "HARD RULES for why_this_job:\n"
        "- 2-3 sentences. No more.\n"
        "- First person. Use 'I' and real past tense verbs (I built, I shipped, I ran).\n"
        "- Name something concrete from the JD: a specific product area, tech, or problem the company solves.\n"
        "- NO banned openers: no 'I am excited', 'I look forward to', 'thrilled', 'honored'.\n"
        "- NO em dashes. NO 'not only...but also'. NO lists of three adjectives or skills.\n"
        "- NO AI vocabulary: leverage, showcase, pivotal, testament, fostering, "
        "align with, maps to, underscore, cutting-edge, vibrant, tapestry, synergize.\n"
        "- NO vague interest phrases: do NOT write 'the kind of X I like building/doing', "
        "'exactly the kind of work I enjoy', 'speaks to my interests', 'resonates with me'. "
        "These are filler. Replace them with a specific fact about what the candidate has done.\n"
        "- NO present-participle add-ons: do not end sentences with 'ensuring...', "
        "'highlighting...', 'reflecting...', 'contributing to...'.\n"
        "- NO copula substitutes: use 'is/are/has', not 'serves as' or 'stands as'.\n"
        "- NO comprehensive skills laundry lists: do not cram CI/CD, Docker, Kubernetes, Python, "
        "REST, and AI into one sentence.\n"
        "- Vary sentence length: one short punchy sentence, one or two longer ones.\n"
        "- Be opinionated and specific. A real person reacting to a real job, not a form letter.\n"
        "- GOOD EXAMPLE tone: 'The data correctness problem at Athennian is the part I'd "
        "actually think about in the shower. I spent two years building test infra that caught "
        "schema drift before it hit production, and that experience transfers directly.' "
        "Notice: specific problem named, specific work cited, no filler phrases.\n"
        "- BAD EXAMPLE (do not write like this): 'Athennian's work maps to the kind of systems "
        "I like building. I have shipped CI/CD, Docker, Kubernetes, Python, REST, and AI "
        "integrations, and I'd bring that infrastructure mindset to protecting sensitive data.'"
    )
